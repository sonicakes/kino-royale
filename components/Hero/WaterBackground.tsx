  ...
  return (
    <div className={styles.root} aria-hidden="true">
      ...
      >
        ...
        {/* Descending light rays — fanned toward left where silhouette sits */}
        <line x1="-80" y1="-60" x2="1080" y2="700" stroke="#2860B0" strokeWidth="80" opacity="0.06" />
        <line x1="-60" y1="-60" x2="880" y2="700" stroke="#2860B0" strokeWidth="60" opacity="0.05" />
        <line x1="-100" y1="-60" x2="620" y2="700" stroke="#1A4A8A" strokeWidth="40" opacity="0.04" />
        <line x1="-40" y1="-60" x2="350" y2="700" stroke="#1A4A8A" strokeWidth="25" opacity="0.03" />

        {/* Surface ripple lines */}
        <ellipse cx="-80" cy="-80" rx="180" ry="12" fill="none" stroke="#4A8AD4" strokeWidth="0.5" opacity="0.25" />
        <ellipse cx="-80" cy="-55" rx="260" ry="18" fill="none" stroke="#2860B0" strokeWidth="0.5" opacity="0.18" />
        <ellipse cx="-80" cy="-30" rx="350" ry="24" fill="none" stroke="#1A4A8A" strokeWidth="0.5" opacity="0.12" />
